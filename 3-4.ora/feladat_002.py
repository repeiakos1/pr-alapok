...
Kérjük be a billentyűzetről a két egész számot, és írassuk ki a két szám összegét képernyőre!
...
print=(f" Az osszeg  változó típusa: {type(osszeg)}")
print=(f" A szam_3 két szám összege: {szam_3}")
